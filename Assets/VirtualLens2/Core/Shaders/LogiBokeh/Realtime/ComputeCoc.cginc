#ifndef VIRTUALLENS2_LOGIBOKEH_REALTIME_COMPUTE_COC_CGINC
#define VIRTUALLENS2_LOGIBOKEH_REALTIME_COMPUTE_COC_CGINC
...
v2f vertex(appdata v){
	...
	if(_Blurring == 0.0 || !isVirtualLensCustomComputeCamera(2048, 1728)){
		o.vertex = 0;
		o.uv     = 0;
		o.params = 0;
		return o;

...
#ifndef NN4VRC_YOLOX_EYE_SELECTOR_REDUCE_CGINC
#define NN4VRC_YOLOX_EYE_SELECTOR_REDUCE_CGINC
...
v2f vertex(appdata v){
	...
	// Write to (4, 0) and (7, 0)
	const float offset = 4.0 / BUFFER_WIDTH;

...
{
    public class RotationConstraintBuildComponentPlugin
        : DefaultBuildComponentPluginBase<XResourceRotationConstraint>
    {
        ...
        )
        {
            ...
            var result = attachTarget.AddComponent<RotationConstraint>();

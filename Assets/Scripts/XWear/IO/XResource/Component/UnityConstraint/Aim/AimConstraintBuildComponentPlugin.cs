...
{
    public class AimConstraintBuildComponentPlugin
        : DefaultBuildComponentPluginBase<XResourceAimConstraint>
    {
        ...
        )
        {
            ...
            var result = attachTarget.AddComponent<AimConstraint>();

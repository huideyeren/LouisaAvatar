...
{
    public class SphereColliderBuildComponentPlugin
        : DefaultBuildComponentPluginBase<XResourceSphereCollider>
    {
        ...
        )
        {
            ...
            var result = attachTarget.AddComponent<SphereCollider>();

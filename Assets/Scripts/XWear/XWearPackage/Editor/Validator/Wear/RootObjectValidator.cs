...
{
    public class RootObjectValidator : IXWearValidator
    {
        private readonly GameObject _rootGameObject;
        private readonly Transform[] _transforms;
        public HumanoidMapComponent HumanoidMapComponent { get; private set; }

        public RootObjectValidator(GameObject rootGameObject, Transform[] transforms)
        {

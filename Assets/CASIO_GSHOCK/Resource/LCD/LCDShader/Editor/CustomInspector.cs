...
namespace lilToon
{
    public class LCDShaderInspector : lilToonInspector
    {
        // Custom properties
        //MaterialProperty customVariable;

        private static bool isShowCustomProperties;
        private const string shaderName = "lilToonLCD";

        // private MaterialProperty colorDataProp;
        private MaterialProperty lcdProp;
        private MaterialProperty typeProp;
        ...
        protected override void LoadCustomProperties(MaterialProperty[] props, Material material)
        {
            ...
            lcdProp = FindProperty("_LCD", props);
            typeProp = FindProperty("_Type", props);
        }
        ...
        protected override void DrawCustomProperties(Material material)
        {
            ...
            if (isShowCustomProperties)
            {
                ...
                m_MaterialEditor.ShaderProperty(lcdProp, "LCD Texture");
                var type = (int)typeProp.floatValue;
                var faceType = (FaceType)EditorGUILayout.EnumPopup("FaceType", (FaceType)type);
                typeProp.floatValue = (int)faceType;

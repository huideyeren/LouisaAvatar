Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/4e3420c7610376542ab6477c1478d830"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = (0.239 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
			...
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					totalFrames -= (totalFrames - min(max((0.0 /*_FlipbookStartFrame*/), (100.0 /*_FlipbookEndFrame*/)), totalFrames));
					totalFrames -= max(0, (0.0 /*_FlipbookStartFrame*/));
				}
				if (!(1.0 /*_FlipbookManualFrameControl*/))
				{
					if ((50.0 /*_FlipbookFPS*/) != 0)
					{
						currentFrame = ((_Time.y / (1 / (50.0 /*_FlipbookFPS*/))) + (0.0 /*_FlipbookFrameOffset*/)) % totalFrames;
						if ((0.0 /*_FlipbookStartAndEnd*/))
						{
				...
				{
					flipBookPixel.rgb = poiThemeColor(poiMods, _FlipbookColor.rgb, (0.0 /*_FlipbookColorThemeIndex*/));
				}
				else
				{
					flipBookPixel.rgb *= poiThemeColor(poiMods, _FlipbookColor.rgb, (0.0 /*_FlipbookColorThemeIndex*/));
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, flipBookPixel.rgb, flipBookPixel.a * _FlipbookColor.a * (1.0 /*_FlipbookReplace*/) * flipBookMask * flipbookAlpha);
				poiFragData.baseColor = poiFragData.baseColor + flipBookPixel.rgb * (0.0 /*_FlipbookAdd*/) * flipBookMask * flipbookAlpha;
				poiFragData.baseColor = poiFragData.baseColor * lerp(1, flipBookPixel.rgb, flipBookPixel.a * _FlipbookColor.a * flipBookMask * (0.0 /*_FlipbookMultiply*/) * flipbookAlpha);
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (0.7 /*_GITDEMinEmissionMultiplier*/), (0.6 /*_GITDEMaxEmissionMultiplier*/), (1.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
